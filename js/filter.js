document.addEventListener("DOMContentLoaded", function () {
    ...
    const items = [
        ...
        { type: "announcements", name: "Annoucement", date: "2022-04-04", description: "5月8日 （日）東京ビッグサイトで開催されます第十九回博麗神社例大祭「い24ab」にスペースを頂きました。" },
        ...
        { type: "announcements", name: "Annoucement", date: "2022-07-29", description: "株式会社タイトー様『東方スペルバブル』の追加ダウンロードコンテンツ「暁Records楽曲パック」が配信開始いたしました。https://www.taito.co.jp/mob/topics/14871" },
      ];
